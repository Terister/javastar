...
public class WkProjectSqlProvider {
    ...
    public String countByExample(WkProjectExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`wk_project`");
    ...
    public String selectByExample(WkProjectExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("`project_id`");
        } else {
            SELECT("`project_id`");
        }
        SELECT("`project_key`");
