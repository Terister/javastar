...
this.jsviews || this.jQuery && jQuery.views || (function (global, undefined) {
    ...
    function renderContent(data, context, parentView, key, isLayout, path, onRender) {
        ...
        if (self.isTag) {
            ...
            for (hasProp in props) {
                break;
            } // Find out if there are any props
    ...
    function tmplFn(markup, tmpl, bind) {
        ...
        var newNode, node, i, l, code, hasTag, hasEncoder, getsValue, hasConverter, hasViewPath, tag, converter, params,
            hash, nestedTmpl, allowCode,
            tmplOptions = tmpl ? {
